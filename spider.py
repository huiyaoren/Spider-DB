...
class Spider:
    ...
    def get_response(self, url):
        ...
        return str(resp.content, encoding='gbk').encode('utf8')
    ...
    def get_urls_session(self):
        ...
        for r in result:
            print(r)
            if len(r.xpath('span[1]/text()')) > 0:
                print(r.xpath('@href')[0])
                print(r.xpath('@title')[0])
                print(r.xpath('span[1]/text()')[0].strip())
        #         todo
        items = []
        # pattern = re.compile(r'(<a href="http://v.dangdang.com/pn0_\d*_3.html.*?</span>)', re.S)
    ...
    def getBookdetail(self, link='http://v.dangdang.com/pn0_10005415_3.html'):
        ...
        for item in items:
            ...
            book['bookname'] = \
                item[8].split("\'", 2)[1].split("（", 1)[0].split("(", 1)[0].split("—", 1)[0].split("-", 1)[0].split("：",
                                                                                                                    1)[
                    0].encode('utf8')
    ...
    def getBookrank(self, bookname="无聊的人生，我死也不要"):
        ...
        for item in items:
            ...
            rankpeople = item.split("pl\">\n", 1)[1].split("</span>", 1)[0].split("(", 1)[1].split(")", 1)[0].encode(
                'utf8')
